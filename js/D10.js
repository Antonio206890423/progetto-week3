...
console.log("questo è il numero random", risultato);
...
console.log("il piu grande è", whoIsBigger(5,10));
...
return stringa.split(" ").map(word => word.charAt(0).toUpperCase() + word.slice(1));
}
let a1 = splitMe("i love coding")
console.log(a1);
...
*/
let email = "bfkgbasocashjkb.gufe"
function isThisAnEmail(email){
  if (email.includes('@')){
    console.log("indirizzo valido",email,true)
    }else {console.log("email non valida", email,false)
    return false}
}
isThisAnEmail(email)
...
let data1 = howManyDays("2023-02-02")
console.log(data1)
...
console.log("Il film piu recente è", filmRecente);
...
console.log("Questo array ha un totale di film :", totalFilm);
...
/*function onlyTheYears(movies) {
  return movies.filter(movies => movies.Year);
}
const year = onlyInLastMillennium(movies);
console.log(year);*/
...
*/
const onlyInLastMillennium = (parametro) =>{
...
const results = searchByTitle(movies, "Film");
console.log(results)
...
/* ESERCIZIO 22
  ...
  contenuto in ogni tag <td> all'interno della pagina.
*/
